...
export PATH=$PATH:/opt/pycharm-2021.3.2/bin
...
export KUBECONFIG=$KUBECONFIG:/home/per-gunnar/.kube/config
export HISTORY_IGNORE="(rm *|reboot|exit|*SECRET*|*PASSWORD*|*TOKEN*|*API*|*KEY*|*PASS*|*SECRETS*|*SECRET_KEY*|*SECRET_TOKEN*|*SECRET_KEY_BASE*|*SECRET_TOKEN_BASE*|GITHUB_PAT*)"
export EDITOR=lvim
